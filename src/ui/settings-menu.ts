...
function build_types_filter_section(): HTMLElement {
    ...
    list.className = "settings-courses-list";
...
function build_courses_section(): HTMLElement {
    const section = document.createElement("div");
    section.className = "settings-section";
    section.id = "spark-settings-courses";
    ...
    const list = document.createElement("div");
    list.id = "spark-settings-courses-list";
    list.className = "settings-courses-list";
...
export function build_settings_panel(): HTMLElement {
    ...
    if (Object.keys(ui_state.last_course_data).length > 0) {
        const courses_list = courses_section.querySelector<HTMLElement>("#spark-settings-courses-list")!;
